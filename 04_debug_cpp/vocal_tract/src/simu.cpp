...
int main() {
    ...
    try{
        {
            h5fid = H5File("/home/victorw/ownCloud/IRCAM/03_DOCS/30_code_cpp_vocal_tract/vocalTractCpp/04_debug_cpp/data/results.h5", H5F_ACC_RDWR);
        }
    }
    catch(FileIException error){
        {
            cerr << "Failed opening /home/victorw/ownCloud/IRCAM/03_DOCS/30_code_cpp_vocal_tract/vocalTractCpp/04_debug_cpp/data/results.h5 file" << endl;
            exit(1);
        }
    }
    ...
    cout << endl << "Done simulating" << endl;
